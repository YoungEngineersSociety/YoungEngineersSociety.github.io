                        ...
                        if (element.id) {
                            ...
                            if (options.show_media === true) {
                                if (element.entities.media && element.entities.media.length > 0) {
                                    ...
                                    if (image_url) {
                                        post.attachment = '<img class="img-responsive" src="' + image_url + '" />';
                                    }
                                }
                            }
                        }
            ...
            facebook: {
                ...
                utility: {
                    ...
                    prepareAttachment: function(element) {
                        ...
                        return '<img class="img-responsive" src="' + image_url + '" />';
                    },
                        ...
                        if (options.show_media === true) {
                            if (element.object.attachments) {
                                $.each(element.object.attachments, function() {
                                    ...
                                    post.attachment = '<img class="img-responsive" src="' + image + '"/>';
                                });
                            }
                        }
                ...
                utility: {
                    ...
                    unifyPostData: function(element) {
                        ...
                        if (options.show_media) {
                            post.attachment = '<img class="img-responsive" src="' + element.images.standard_resolution.url + '' + '" />';
                        }
                        return post;
                    }
                }
                        ...
                        if (options.show_media) {
                            if (element.attachment) {
                                if (element.attachment.type === 'link')
                                    post.attachment = '<img class="img-responsive" src="' + element.attachment.link.image_src + '" />';
                                if (element.attachment.type === 'video')
                                    post.attachment = '<img class="img-responsive" src="' + element.attachment.video.image_big + '" />';
                                if (element.attachment.type === 'photo')
                                    post.attachment = '<img class="img-responsive" src="' + element.attachment.photo.src_big + '" />';
                            }
                        }
                        ...
                        $.each(json.feed.entry, function() {
                            ...
                            if (options.show_media) {
                                if (element['media$thumbnail']) {
                                    post.attachment = '<img class="img-responsive" src="' + element['media$thumbnail']['url'] + '" />';
                                }
                            }
            ...
            pinterest: {
                ...
                utility: {
                    ...
                    unifyPostData: function(element){
                        ...
                        if (options.show_media) {
                            post.attachment = '<img class="img-responsive" src="' + element.image['original'].url + '" />';
                        }
                        return post;
                    }
                }
                ...
                utility: {
                    ...
                    unifyPostData: function(index, element){
                        ...
                        if (options.show_media && element.mediaGroups ) {
                            post.attachment = '<img class="img-responsive" src="' + element.mediaGroups[0].contents[0].url + '" />';
                        }
                        return post;
                    }
                }
